      ...
      <ul className="nav pull-right top-menu">
              ...
              <a href={"/"}>
                ...
                <div className="progress progress-striped">
                  <div className="progress-bar progress-bar-warning" role="progressbar" aria-valuenow={30} aria-valuemin={0} aria-valuemax={100} style={{width: '30%'}}>
                    <span className="sr-only">90% Complete (warning)</span>
                  </div>
                </div>
              </a>
            </li>
        ...
        <li id="mail_notificatoin_bar" className="dropdown">
          ...
          <ul className="dropdown-menu extended inbox">
            ...
            <li>
              <p className="blue">You have 51 new messages</p>
            </li>
            <li>
                                <a href={"/"}>
                                  <span className="photo"><img alt="avatar" src="./img/avatar-mini.jpg"></img></span>
            ...
            <li><a href={"/"}>
                                  <span className="photo"><img alt="avatar" src="./img/avatar-mini2.jpg"></img></span>
                                  <span className="subject">
            ...
            <li><a href={"/"}>
                                  <span className="photo"><img alt="avatar" src="./img/avatar-mini3.jpg"></img></span>
                                  <span className="subject">
                                  <span className="from">Phillip   Park</span>
                                  <span className="time">2 hrs</span>
                                  </span>
                                  <button className="icon-reorder tooltips" data-original-title="Toggle Navigation" data-placement="bottom">
            ...
            <li><a href={"/"}>
                                  <span className="photo"><img alt="avatar" src="./img/avatar-mini4.jpg"></img></span>
                                  <span className="subject">
        ...
        <li id="alert_notificatoin_bar" className="dropdown">
          ...
          <ul className="dropdown-menu extended notification">
            <div className="notify-arrow notify-arrow-blue"></div>
            <li>
              <p className="blue">You have 71 new notifications</p>
            </li>
            <li><a href={"/"}>
            ...
            <li><a href={"/"}>See all notifications</a>
            </li>
          </ul>
        </li>
        <li className="dropdown"><a data-toggle="dropdown" className="dropdown-toggle" href={"/"}>
